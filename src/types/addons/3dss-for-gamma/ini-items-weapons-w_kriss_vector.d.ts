...
// `items/weapons/w_kriss_vector.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    wpn_kriss_vector: {
      ...
      scripted_snd_reload_misfire_jammed: string
      shell_dir: vector
    ...
    wpn_kriss_vector_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_kriss_vector_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_e0t2: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_kriss_vector_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_compm4s: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_kriss_vector_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_eot: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'silencer_x' | 'silencer_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_kriss_vector_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_rmr: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_kriss_vector_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_ac10632: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_kriss_vector_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_0kp2: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_kriss_vector_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_acog: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_kriss_vector_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_kriss_vector_c-more': Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_kriss_vector_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_kriss_vector_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_kemper: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_kriss_vector_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_kriss_vector_mepro: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_kriss_vector_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_kriss_vector_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
