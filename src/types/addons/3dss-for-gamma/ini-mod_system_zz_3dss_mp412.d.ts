...
declare global {
  interface ModSystemZz3dssMp412Ini {
    'wpn_mp412_c-more': {
      '1icon_layer': string
    ...
    wpn_mp412_deltapoint: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp412_deltapoint_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_mp412.ltx': ModSystemZz3dssMp412Ini
  }
}
