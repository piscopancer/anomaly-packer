...
// `items/weapons/w_vihr.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_vihr_1p29: Omit<ItemsWeaponsBaseIni['wpn_vihr'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_vihr_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_vihr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vihr_kobra: Omit<ItemsWeaponsBaseIni['wpn_vihr'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vihr_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_vihr_1p29_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vihr_ps01: Omit<ItemsWeaponsBaseIni['wpn_vihr'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vihr_pso1_hud: Omit<ItemsWeaponsBaseIni['wpn_vihr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vihr_pso1m21: Omit<ItemsWeaponsBaseIni['wpn_vihr'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_vihr_pso1m21_hud: Omit<ItemsWeaponsBaseIni['wpn_vihr_1p29_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
