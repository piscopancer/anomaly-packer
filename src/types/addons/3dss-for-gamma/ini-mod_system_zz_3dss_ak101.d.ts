...
declare global {
  interface ModSystemZz3dssAk101Ini {
    wpn_ak101_ekp8_02: {
      '1icon_layer': string
    ...
    wpn_ak101_1p78gs_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_ak101_1pn93n2_1gs: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak101_1pn93n2_1gs_hud: {
      aim_hud_offset_alt_pos: vector
      aim_hud_offset_alt_pos_16x9: vector
      aim_hud_offset_alt_rot: vector
      aim_hud_offset_alt_rot_16x9: vector
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_ak101.ltx': ModSystemZz3dssAk101Ini
  }
}
