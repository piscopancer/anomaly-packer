...
// `items/weapons/w_ak105.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_ak105_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak105'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_ak105_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_ak105_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak105_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak105'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak105_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_ak105_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak105_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak105'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak105_pso1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak105_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
