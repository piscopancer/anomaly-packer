...
// `items/weapons/w_bizon.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_bizon_kobra: Omit<ItemsWeaponsBaseIni['wpn_bizon'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_bizon_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_bizon_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_bizon_ekp8_02: Omit<ItemsWeaponsBaseIni['wpn_bizon'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_bizon_ekp8_02_hud: Omit<ItemsWeaponsBaseIni['wpn_bizon_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_bizon_okp: Omit<ItemsWeaponsBaseIni['wpn_bizon'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_bizon_okp_hud: Omit<ItemsWeaponsBaseIni['wpn_bizon_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_bizon_1p76: Omit<ItemsWeaponsBaseIni['wpn_bizon'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_bizon_1p76_hud: Omit<ItemsWeaponsBaseIni['wpn_bizon_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_bizon_ps01: ItemsWeaponsBaseIni['wpn_bizon']
    wpn_bizon_ps01_hud: ItemsWeaponsBaseIni['wpn_bizon_hud']
    wpn_bizon_1p29: ItemsWeaponsBaseIni['wpn_bizon']
    wpn_bizon_1p29_hud: ItemsWeaponsBaseIni['wpn_bizon_hud']
  }
}
