...
// `items/weapons/w_ak103.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_ak103_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak103'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_ak103_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak103_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak103'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak103_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak103_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak103'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak103_pso1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak103_camo: Omit<ItemsWeaponsBaseIni['wpn_ak103'], 'condition_queue_shot_dec' | 'condition_shot_dec' | 'cost' | 'fire_dispersion_base' | 'hud' | 'installed_upgrades' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'misfire_end_condition' | 'misfire_end_prob' | 'misfire_start_condition' | 'misfire_start_prob' | 'parent_section' | 'rpm' | 'visual'> & {
      condition_queue_shot_dec: number
      condition_shot_dec: number
      cost: number
      fire_dispersion_base: number
    ...
    wpn_ak103_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak103_camo_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak103_camo'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak103_1p29_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_1p29_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak103_camo_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak103_camo'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak103_kobra_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_kobra_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak103_camo_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak103_camo'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak103_pso1_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak103_pso1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
