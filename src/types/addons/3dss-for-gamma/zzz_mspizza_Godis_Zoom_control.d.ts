// AUTO-GENERATED addon pack for `3dss-for-gamma` by `anomaly-packer gen-addon`. Lua API of zzz_mspizza_Godis_Zoom_control.script.
// Refine `TODO` (= any) by hand where the mod gave no type.

/** @noSelf */
declare const zzz_mspizza_Godis_Zoom_control: {
