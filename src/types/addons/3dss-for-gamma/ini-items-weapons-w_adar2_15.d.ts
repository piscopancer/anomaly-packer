...
// `items/weapons/w_adar2_15.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_adar2_15_acog: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_ac10632: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_eot: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_adar2_15_c-more': Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    'wpn_adar2_15_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_specter: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], 'hud'> & {
      hud: string
    }
    wpn_adar2_15_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_mepro: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_leupold: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], 'hud'> & {
      hud: string
    }
    wpn_adar2_15_leupold_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_point_aimpro: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_point_aimpro_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_e0t2: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_pn23: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_pn23_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_compm4s: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_marchf: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_marchf_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_kemper: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_adar2_15_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_triji: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_adar2_15_triji_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_spec_alt: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_adar2_15_spec_alt_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_adar2_15_mark8_rmr: Omit<ItemsWeaponsBaseIni['wpn_adar2_15'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_adar2_15_mark8_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_adar2_15_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
