...
// `items/weapons/w_pkp_siber.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_pkp_siber_kobra: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_pkp_siber_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_ekp8_02: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_ekp8_02_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_okp: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_okp_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_pso2: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_pso2_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_1p76: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_1p76_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_pka: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_pka_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_1p78gs: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_1p78gs_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_1pn93: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_1pn93_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_1p29: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_usp1: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_usp1_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_ps01: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_ps01_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_1p59: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_1p59_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
    wpn_pkp_siber_pso1m21: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'snd_reload' | 'snd_reload_empty'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_pkp_siber_pso1m21_hud: Omit<ItemsWeaponsBaseIni['wpn_pkp_siber_hud'], 'anm_reload' | 'anm_reload_empty' | 'item_visual'> & {
      anm_reload: CommaSeparatedString<string[]>
      anm_reload_empty: CommaSeparatedString<string[]>
      item_visual: string
    }
