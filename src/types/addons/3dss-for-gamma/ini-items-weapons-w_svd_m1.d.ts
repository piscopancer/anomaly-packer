...
// `items/weapons/w_svd_m1.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_svd_m1_pso2: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_svd_m1_pso2_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_1p78gs: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_1p78gs_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '$spawn' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      $spawn: string
      hud: string
      use_alt_aim_hud: boolean
      visual: string
    }
    wpn_svd_m1_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_1pn93: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_1pn93_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_1p29: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_usp1: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_usp1_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_ps01: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_ps01_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_pso1m21: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_pso1m21_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_svd_m1_1p59: Omit<ItemsWeaponsBaseIni['wpn_svd_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_svd_m1_1p59_hud: Omit<ItemsWeaponsBaseIni['wpn_svd_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
