...
// `items/weapons/w_ak74.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_ak74_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak74'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_ak74_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_ak74_hud'], 'aim_hud_offset_pos' | 'aim_hud_offset_pos_16x9' | 'item_visual'> & {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_ak74_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak74'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak74_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_ak74_hud'], 'aim_hud_offset_pos' | 'aim_hud_offset_pos_16x9' | 'aim_hud_offset_rot' | 'aim_hud_offset_rot_16x9' | 'item_visual'> & {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      aim_hud_offset_rot: vector
      aim_hud_offset_rot_16x9: vector
    ...
    wpn_ak74_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak74'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak74_pso1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak74_hud'], 'aim_hud_offset_pos' | 'aim_hud_offset_pos_16x9' | 'item_visual'> & {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
