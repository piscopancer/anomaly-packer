...
// `items/weapons/w_ak12_m1.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    wpn_ak12_m1: {
      ...
      scripted_snd_ammo_check_empty_w_gl_aim: string
      scripted_snd_ammo_check_w_gl: string
      scripted_snd_ammo_check_w_gl_aim: string
      scripted_snd_hide: string
      scripted_snd_hide_g: string
      scripted_snd_hide_w_gl: string
      scripted_snd_show: string
      scripted_snd_show_g: string
      scripted_snd_show_w_gl: string
      scripted_snd_switch: string
      scripted_snd_switch_g: string
      shell_bone: string
      shell_dir: vector
    ...
    wpn_ak12_m1_hud: {
      ...
      anm_reload_misfire_w_gl_aim: CommaSeparatedString<string[]>
      anm_reload_w_gl: string
      anm_shots: string
      anm_shots_aim: string
      anm_shots_g: CommaSeparatedString<string[]>
      anm_shots_w_gl: string
      anm_shots_w_gl_aim: string
      ...
      anm_switch_mode_w_gl_aim: CommaSeparatedString<string[]>
    ...
    wpn_ak12_m1_ac10632: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_ak12_m1_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_acog: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_eot: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_ak12_m1_c-more': Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_ak12_m1_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_specter: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_0kp2: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_d0cter: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_mepro: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_leupold: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_leupold_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_aim_low: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_aim_low_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_point_aimpro: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_point_aimpro_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_e0t2: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_pn23: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_pn23_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_gauss_sight: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_gauss_sight_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_deltapoint: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_deltapoint_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_rmr: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_compm4s: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_rakurs: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_rakurs_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_susat: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_susat_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_marchf: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_marchf_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_kemper: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak12_m1_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_triji: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_ak12_m1_triji_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_spec_alt: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_ak12_m1_spec_alt_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak12_m1_mark8_rmr: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_ak12_m1_mark8_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_ak12_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
