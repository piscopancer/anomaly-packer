...
// `items/weapons/w_9a91.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_9a91_1p29: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_9a91_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_usp1: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_usp1_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_1p78gs: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_1p78gs_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_kobra: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_pka: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_pka_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_1p76: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_1p76_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_ekp8_02: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_ekp8_02_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_okp: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_okp_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_pso1m21: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_9a91_pso1m21_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_pso2: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_pso2_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_1pn93: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_1pn93_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_1p59: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_9a91_1p59_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_9a91_ps01: Omit<ItemsWeaponsBaseIni['wpn_9a91'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_9a91_ps01_hud: Omit<ItemsWeaponsBaseIni['wpn_9a91_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
