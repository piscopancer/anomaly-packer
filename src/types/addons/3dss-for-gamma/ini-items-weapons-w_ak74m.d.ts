...
// `items/weapons/w_ak74m.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_ak74m_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak74m'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_ak74m_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_ak74m_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak74m_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak74m'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak74m_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_ak74m_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak74m_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak74m'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak74m_pso1_hud: ItemsWeaponsBaseIni['wpn_ak74m_hud']
    wpn_ak74m_camo: Omit<ItemsWeaponsBaseIni['wpn_ak74m'], 'parent_section'> & {
      parent_section: string
    }
    wpn_ak74m_camo_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak74m_kobra'], 'parent_section'> & {
      parent_section: string
    }
    wpn_ak74m_camo_ekp8_02: {
      parent_section: string
    }
    wpn_ak74m_camo_okp: {
      parent_section: string
    ...
    wpn_ak74m_camo_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak74m_ps01'], 'parent_section'> & {
      parent_section: string
    }
    wpn_ak74m_camo_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak74m_1p29'], 'parent_section'> & {
      parent_section: string
    }
    wpn_ak74m_camo_1p78gs: {
      parent_section: string
    }
    wpn_ak74m_camo_1pn93n2_1gs: {
      parent_section: string
    }
    wpn_ak74m_camo_1pn93: {
      parent_section: string
    }
    wpn_ak74m_camo_pso2: {
      parent_section: string
    }
    wpn_ak74m_camo_pso1m21: {
      parent_section: string
    }
    wpn_ak74m_camo_usp1: {
      parent_section: string
