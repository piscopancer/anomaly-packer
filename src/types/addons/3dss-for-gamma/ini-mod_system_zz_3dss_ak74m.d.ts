...
declare global {
  interface ModSystemZz3dssAk74mIni {
    wpn_ak74m_ekp8_02: {
      '1icon_layer': string
    ...
    wpn_ak74m_1p78gs_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_ak74m_1pn93n2_1gs: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_ak74m.ltx': ModSystemZz3dssAk74mIni
  }
}
