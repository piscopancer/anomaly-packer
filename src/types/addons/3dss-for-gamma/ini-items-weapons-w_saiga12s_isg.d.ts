...
// `items/weapons/w_saiga12s_isg.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_saiga12s_isg_ac10632: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_saiga12s_isg_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_eot: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_saiga12s_isg_c-more': Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_saiga12s_isg_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_d0cter: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_mepro: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_0kp2: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_e0t2: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_rmr: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_deltapoint: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_deltapoint_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_kemper: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_acog: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_specter: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_isg_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_isg_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
