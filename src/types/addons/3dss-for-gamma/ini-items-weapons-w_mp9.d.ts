...
// `items/weapons/w_mp9.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    wpn_mp9: {
      ...
      snd_shoot_actor1: string
      snd_shoot_actor2: string
      snd_shoot_actor3: string
      snd_shoot_actor4: string
      snd_shoot_actor5: string
      snd_shot_last: string
      snd_shot_last_actor: string
      snd_silencer_shot_last: string
      snd_silencer_shot_last_actor: string
      snd_silncer_shot: string
      snd_silncer_shot_actor: string
      snd_silncer_shot_actor1: string
      snd_silncer_shot_actor2: string
      snd_silncer_shot_actor3: string
      snd_silncer_shot_actor4: string
      snd_silncer_shot_actor5: string
      snd_sprint_idle: string
    ...
    wpn_mp9_hud: {
      ...
      anm_firemode: string
      anm_firemode_empty: CommaSeparatedString<string[]>
      anm_hide: string
      ...
      anm_idle_moving_slow_empty: CommaSeparatedString<string[]>
      anm_idle_sprint: string
      anm_idle_sprint_0: string
      anm_idle_sprint_1: string
      anm_idle_sprint_2: string
      ...
      anm_shots_last: CommaSeparatedString<string[]>
      anm_shots_when_aim: CommaSeparatedString<string[]>
      anm_shots_when_aim_last: CommaSeparatedString<string[]>
      anm_show: string
      anm_show_empty: CommaSeparatedString<string[]>
      anm_sprint_end: string
      anm_sprint_end_0: string
      anm_sprint_end_1: string
      anm_sprint_start: string
      anm_sprint_start_0: string
      anm_sprint_start_1: string
    ...
    wpn_mp9_ac10632: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_aim_low: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_aim_low_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_compm4s: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_eot: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_e0t2: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_kemper: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_0kp2: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_mp9_c-more': Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    'wpn_mp9_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_he510: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_he510_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_exps3: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_exps3_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_deltapoint: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_deltapoint_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_d0cter: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_mepro: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_rakurs: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_rakurs_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp9_rmr: Omit<ItemsWeaponsBaseIni['wpn_mp9'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp9_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_mp9_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
