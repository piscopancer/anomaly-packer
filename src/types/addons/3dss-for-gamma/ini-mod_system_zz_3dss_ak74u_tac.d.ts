...
declare global {
  interface ModSystemZz3dssAk74uTacIni {
    wpn_ak74u_tac_p1x42: {
      '1icon_layer': string
    ...
    wpn_ak74u_tac_pso1m21: {
      '1icon_layer': string
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak74u_tac_pso1m21_hud: {
      aim_hud_offset_alt_pos: vector
      aim_hud_offset_alt_pos_16x9: vector
      aim_hud_offset_alt_rot: CommaSeparatedString<string[]>
      aim_hud_offset_alt_rot_16x9: CommaSeparatedString<string[]>
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_ak74u_tac.ltx': ModSystemZz3dssAk74uTacIni
  }
}
