...
// `items/weapons/w_vityaz.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_vityaz_ac10632: Omit<ItemsWeaponsBaseIni['wpn_vityaz'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_vityaz_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_vityaz_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vityaz_acog: Omit<ItemsWeaponsBaseIni['wpn_vityaz'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vityaz_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_vityaz_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vityaz_eot: Omit<ItemsWeaponsBaseIni['wpn_vityaz'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vityaz_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_vityaz_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_vityaz_c-more': Omit<ItemsWeaponsBaseIni['wpn_vityaz'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_vityaz_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_vityaz_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
