...
declare global {
  interface ModSystemZz3dssBizonIni {
    wpn_bizon_1p63: {
      '1icon_layer': string
    ...
    wpn_bizon_1p78gs_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_bizon_1pn93n2_1gs: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_bizon.ltx': ModSystemZz3dssBizonIni
  }
}
