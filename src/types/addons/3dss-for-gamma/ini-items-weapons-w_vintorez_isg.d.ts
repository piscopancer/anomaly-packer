...
// `items/weapons/w_vintorez_isg.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_vintorez_isg_1p29: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_vintorez_isg_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_acog: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_specter: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_1pn93: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_1pn93_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_leupold: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_leupold_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_gauss_sight: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_gauss_sight_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_pn23: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_pn23_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_susat: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_susat_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_marchf: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_marchf_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_usp1: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_usp1_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_ps01: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_vintorez_isg_ps01_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_pso2: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_pso2_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_pso1m21: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_pso1m21_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_vintorez_isg_1p59: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_vintorez_isg_1p59_hud: Omit<ItemsWeaponsBaseIni['wpn_vintorez_isg_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
