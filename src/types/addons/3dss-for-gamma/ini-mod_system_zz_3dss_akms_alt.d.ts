...
declare global {
  interface ModSystemZz3dssAkmsAltIni {
    wpn_akms_alt_ekp8_02: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_akms_alt_ekp8_02_hud: {
    ...
    wpn_akms_alt_1p78gs_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_akms_alt_1pn93n2_1gs: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_akms_alt.ltx': ModSystemZz3dssAkmsAltIni
  }
}
