...
// `items/weapons/w_mp5.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_mp5_ac10632: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_eot: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_e0t2: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_mepro: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_he510: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_he510_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_romeo4: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_romeo4_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_p1x42: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_p1x42_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_bossxe: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'laser_status' | 'use_alt_aim_hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp5_bossxe_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_acog: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_monstrum: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_monstrum_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_trihawk: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_trihawk_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_specter: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_vulcan: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_vulcan_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_c79: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_c79_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_e0t2_magd: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_e0t2_magd_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_e0t2_magd_off: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_e0t2_magd_off_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp5_tac30: Omit<ItemsWeaponsBaseIni['wpn_mp5'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_mp5_tac30_hud: Omit<ItemsWeaponsBaseIni['wpn_mp5_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
