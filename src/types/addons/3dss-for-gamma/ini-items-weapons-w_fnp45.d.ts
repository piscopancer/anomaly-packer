...
// `items/weapons/w_fnp45.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_fnx45_custom: Omit<ItemsWeaponsBaseIni['wpn_fnp45'], 'cam_dispersion' | 'cam_dispersion_frac' | 'cam_dispersion_inc' | 'cam_max_angle' | 'cam_max_angle_horz' | 'cam_step_angle_horz' | 'condition_queue_shot_dec' | 'condition_shot_dec' | 'control_inertion_factor' | 'cost' | 'description' | 'fire_dispersion_base' | 'hud' | 'installed_upgrades' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'inv_weight' | 'misfire_end_condition' | 'misfire_end_prob' | 'misfire_start_condition' | 'misfire_start_prob' | 'rpm' | 'silencer_status' | 'upgrade_scheme' | 'upgrades' | 'visual' | 'zoom_cam_dispersion'> & {
      cam_dispersion: number
      cam_dispersion_frac: number
      cam_dispersion_inc: number
      cam_max_angle: number
    ...
    wpn_fnx45_hud: Omit<ItemsWeaponsBaseIni['wpn_fnp45_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_fnx45_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_fnx45_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_fnx45: Omit<ItemsWeaponsBaseIni['wpn_fnx45_custom'], 'parent_section'> & {
