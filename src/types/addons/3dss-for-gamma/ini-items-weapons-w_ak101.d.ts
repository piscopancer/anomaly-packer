...
// `items/weapons/w_ak101.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_ak101_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak101'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'inv_weight' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_ak101_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_hud'], 'aim_hud_offset_pos' | 'aim_hud_offset_pos_16x9' | 'item_visual'> & {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_ak101_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak101'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'inv_weight' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak101_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_hud'], 'aim_hud_offset_pos' | 'aim_hud_offset_pos_16x9' | 'aim_hud_offset_rot' | 'aim_hud_offset_rot_16x9' | 'item_visual'> & {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      aim_hud_offset_rot: vector
      aim_hud_offset_rot_16x9: vector
    ...
    wpn_ak101_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak101'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak101_pso1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak101_camo: Omit<ItemsWeaponsBaseIni['wpn_ak101'], 'bullet_speed' | 'condition_queue_shot_dec' | 'condition_shot_dec' | 'cost' | 'fire_dispersion_base' | 'hud' | 'installed_upgrades' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'misfire_end_condition' | 'misfire_end_prob' | 'misfire_start_condition' | 'misfire_start_prob' | 'parent_section' | 'rpm' | 'visual'> & {
      bullet_speed: number
      condition_queue_shot_dec: number
      condition_shot_dec: number
      cost: number
    ...
    wpn_ak101_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak101_camo_1p29: Omit<ItemsWeaponsBaseIni['wpn_ak101_camo'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak101_1p29_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_1p29_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak101_camo_kobra: Omit<ItemsWeaponsBaseIni['wpn_ak101_camo'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_ak101_kobra_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_kobra_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_ak101_camo_ps01: Omit<ItemsWeaponsBaseIni['wpn_ak101_camo'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak101_pso1_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_ak101_pso1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
