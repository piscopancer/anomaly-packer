...
// `items/weapons/w_toz194.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_wincheaster1300_trapper: Omit<ItemsWeaponsBaseIni['wpn_wincheaster1300'], '$spawn'> & {
      $spawn: string
    }
    wpn_toz194_hud: {
