...
// `items/weapons/w_fal_aus.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_fal_aus_kit_aus_tri: Omit<ItemsWeaponsBaseIni['wpn_fal_aus'], 'description' | 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'inv_weight' | 'visual'> & {
      description: string
      hud: string
      inv_grid_height: number
      inv_grid_width: number
    ...
    wpn_fal_aus_kit_aus_tri_hud: Omit<ItemsWeaponsBaseIni['wpn_fal_aus_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_fal_aus_kit_sa5x_spec: Omit<ItemsWeaponsBaseIni['wpn_fal_aus'], 'description' | 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'inv_weight' | 'visual'> & {
      description: string
      hud: string
      inv_grid_height: number
      inv_grid_width: number
    ...
    wpn_fal_aus_kit_sa5x_spec_hud: Omit<ItemsWeaponsBaseIni['wpn_fal_aus_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_fal_aus_kit_fal_leup: Omit<ItemsWeaponsBaseIni['wpn_fal_aus'], 'description' | 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'inv_weight' | 'visual'> & {
      description: string
      hud: string
      inv_grid_height: number
      inv_grid_width: number
    ...
    wpn_fal_aus_kit_fal_leup_hud: Omit<ItemsWeaponsBaseIni['wpn_fal_aus_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
