...
// `items/weapons/w_p90gamma.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_p90gamma_ac10632: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_p90gamma_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_eot: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_e0t2: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_aim_low: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_aim_low_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_point_aimpro: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_point_aimpro_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_compm4s: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_kemper: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_mepro: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_rmr: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_d0cter: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_specter: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_p90gamma_acog: Omit<ItemsWeaponsBaseIni['wpn_p90gamma'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_p90gamma_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_p90gamma_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
