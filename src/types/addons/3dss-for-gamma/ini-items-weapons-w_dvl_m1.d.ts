...
// `items/weapons/w_dvl_m1.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_dvl10_m1_acog: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
    ...
    wpn_dvl10_m1_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_specter: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
    ...
    wpn_dvl10_m1_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_pks: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
    ...
    wpn_dvl10_m1_pks_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_leupold: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
    ...
    wpn_dvl10_m1_leupold_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_pn23: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
    ...
    wpn_dvl10_m1_pn23_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_gauss_sight: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
    ...
    wpn_dvl10_m1_gauss_sight_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_susat: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'inv_weight' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_dvl10_m1_susat_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_dvl10_m1_marchf: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_dvl10_m1_marchf_hud: Omit<ItemsWeaponsBaseIni['wpn_dvl10_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
