...
// `items/weapons/w_mosin.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    wpn_mosin: {
      ...
      snd_add_cartridge4: string
      snd_add_cartridge5: string
      snd_bore: string
      snd_draw: string
      snd_empty: string
      snd_holster: string
    ...
    wpn_mosin_wpn_addon_scope_pu: Omit<ItemsWeaponsBaseIni['wpn_mosin'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'use_alt_aim_hud'> & {
      '1icon_layer': string
    ...
    wpn_mosin_wpn_addon_scope_pu_hud: Omit<ItemsWeaponsBaseIni['wpn_mosin_hud'], 'aim_hud_offset_alt_pos' | 'aim_hud_offset_alt_pos_16x9' | 'aim_hud_offset_alt_rot' | 'aim_hud_offset_alt_rot_16x9' | 'aim_hud_offset_pos' | 'aim_hud_offset_pos_16x9' | 'aim_hud_offset_rot' | 'aim_hud_offset_rot_16x9'> & {
      aim_hud_offset_alt_pos: vector
      aim_hud_offset_alt_pos_16x9: vector
      aim_hud_offset_alt_rot: vector
      aim_hud_offset_alt_rot_16x9: vector
