...
// `items/weapons/w_k98_mod.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_k98_mod_silen98: Omit<ItemsWeaponsBaseIni['wpn_k98_mod'], '$spawn' | 'bullet_speed' | 'description' | 'fire_dispersion_base' | 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'inv_weight' | 'parent_section' | 'silencer_light_color' | 'silencer_light_range' | 'silencer_light_time' | 'silencer_light_var_color' | 'silencer_light_var_range' | 'silencer_smoke_particles' | 'silencer_status' | 'silencer_x' | 'silencer_y' | 'visual' | 'zoom_cam_dispersion' | 'zoom_cam_dispersion_inc' | 'zoom_cam_step_angle_horz'> & {
      $spawn: string
      bullet_speed: number
      description: string
      fire_dispersion_base: number
    ...
    wpn_k98_mod_silen98_hud: Omit<ItemsWeaponsBaseIni['wpn_k98_mod_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
