...
// `items/weapons/w_toz106_m1.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_snk_toz106m1_shoot_actor: {
      ...
      snd_4_layer: string
      snd_4_layer1: string
      snd_4_layer10: string
      snd_4_layer11: string
      snd_4_layer12: string
      snd_4_layer13: string
      snd_4_layer14: string
      snd_4_layer15: string
      snd_4_layer16: string
      snd_4_layer17: string
      snd_4_layer2: string
      snd_4_layer3: string
      snd_4_layer4: string
      snd_4_layer5: string
    ...
    wpn_toz106_m1_hud: {
      ...
      anm_shots_aim1: CommaSeparatedString<string[]>
      anm_shots_aim2: CommaSeparatedString<string[]>
    ...
    wpn_toz106_m1_ac10632: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_toz106_m1_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_toz106_m1_c-more': Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_toz106_m1_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_toz106_m1_d0cter: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_toz106_m1_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_toz106_m1_aim_low: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_toz106_m1_aim_low_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_toz106_m1_rmr: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_toz106_m1_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_toz106_m1_deltapoint: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_toz106_m1_deltapoint_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_toz106_m1_0kp2: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_toz106_m1_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_toz106_m1_rakurs: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1'], '$spawn' | '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      $spawn: string
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
    ...
    wpn_toz106_m1_rakurs_hud: Omit<ItemsWeaponsBaseIni['wpn_toz106_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
