...
// `items/weapons/w_scar_siber.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_scar_siber_hud: {
      ...
      anm_bore_empty_w_gl: CommaSeparatedString<string[]>
      anm_bore_w_gl: CommaSeparatedString<string[]>
      anm_hide: string
      anm_hide_empty: CommaSeparatedString<string[]>
      anm_hide_empty_w_gl: CommaSeparatedString<string[]>
      ...
      anm_idle_empty_w_gl: CommaSeparatedString<string[]>
      anm_idle_empty_w_gl_aim: CommaSeparatedString<string[]>
      ...
      anm_idle_moving_crouch_empty_w_gl: CommaSeparatedString<string[]>
      anm_idle_moving_crouch_empty_w_gl_aim: CommaSeparatedString<string[]>
      ...
      anm_idle_moving_empty_w_gl: CommaSeparatedString<string[]>
      anm_idle_moving_empty_w_gl_aim: CommaSeparatedString<string[]>
      ...
      anm_idle_sprint_empty_w_gl: CommaSeparatedString<string[]>
      ...
      anm_shots_empty: CommaSeparatedString<string[]>
      anm_shots_empty_w_gl: CommaSeparatedString<string[]>
      ...
      anm_show_empty_w_gl: CommaSeparatedString<string[]>
    ...
    wpn_scar_siber_ac10632: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_scar_siber_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_acog: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_eot: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_scar_siber_c-more': Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_scar_siber_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_specter: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_0kp2: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_mepro: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_leupold: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_leupold_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_point_aimpro: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_point_aimpro_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_e0t2: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_pn23: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_pn23_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_gauss_sight: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_gauss_sight_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_compm4s: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_susat: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_susat_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_marchf: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'scope_dynamic_zoom' | 'scope_status' | 'scope_texture' | 'scope_zoom_factor' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_marchf_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_kemper: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_scar_siber_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_triji: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_scar_siber_triji_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_spec_alt: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_scar_siber_spec_alt_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_scar_siber_mark8_rmr: Omit<ItemsWeaponsBaseIni['wpn_scar_siber'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_scar_siber_mark8_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_scar_siber_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
