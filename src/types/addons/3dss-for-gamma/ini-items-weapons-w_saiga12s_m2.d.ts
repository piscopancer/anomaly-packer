...
// `items/weapons/w_saiga12s_m2.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_saiga12s_m2_ac10632: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_saiga12s_m2_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_eot: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_saiga12s_m2_c-more': Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_saiga12s_m2_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_aim_low: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_aim_low_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_point_aimpro: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_point_aimpro_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_d0cter: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_mepro: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_0kp2: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_0kp2_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_e0t2: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_rmr: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_deltapoint: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_deltapoint_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_kemper: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_acog: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m2_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m2_specter: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_saiga12s_m2_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m2_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
