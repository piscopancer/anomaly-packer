...
// `items/weapons/w_raptr.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_raptr_acog: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_compm4s: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_eot: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_kemper: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_mepro: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_mepro_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_specter: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_specter_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_ekp8_18: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_ekp8_18_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_e0t2: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_susat: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_susat_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_point_aimpro: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_point_aimpro_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_raptr_aimpoint: Omit<ItemsWeaponsBaseIni['wpn_raptr'], 'hud' | 'inv_grid_height' | 'inv_grid_width' | 'inv_grid_x' | 'inv_grid_y' | 'visual'> & {
      hud: string
      inv_grid_height: number
      inv_grid_width: number
      inv_grid_x: number
    ...
    wpn_raptr_aimpoint_hud: Omit<ItemsWeaponsBaseIni['wpn_raptr_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
