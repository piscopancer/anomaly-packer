...
// `items/weapons/w_saiga12s_m1.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_saiga12s_m1_kobra: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_saiga12s_m1_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_okp: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_okp_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_ekp8_02: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_ekp8_02_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_1p76: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_1p76_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_pka: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_pka_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_1p78gs: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_1p78gs_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_1pn93: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_1pn93_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_usp1: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_usp1_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_pso2: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_pso2_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_1p29: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_saiga12s_m1_ps01: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_saiga12s_m1_ps01_hud: Omit<ItemsWeaponsBaseIni['wpn_saiga12s_m1_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
