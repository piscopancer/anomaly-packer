...
// `items/weapons/w_aek.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_aek_hud: {
      ...
      anm_shots_aim_w_gl: CommaSeparatedString<string[]>
    ...
    wpn_aek_kobra: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_ekp8_02: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_ekp8_02_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_okp: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_okp_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_pso2: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_pso2_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_1p76: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_1p76_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_pka: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_pka_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_1p78gs: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_1p78gs_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_1pn93n2_1gs: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_1pn93n2_1gs_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_1pn93: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek971_1pn93_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_1p29: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_usp1: Omit<ItemsWeaponsBaseIni['wpn_aek'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_aek_usp1_hud: Omit<ItemsWeaponsBaseIni['wpn_aek_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_aek_ps01: ItemsWeaponsBaseIni['wpn_aek_pso2']
    wpn_aek_camo: ItemsWeaponsBaseIni['wpn_aek']
    wpn_aek_camo_hud: ItemsWeaponsBaseIni['wpn_aek_hud']
    wpn_aek_camo_kobra: ItemsWeaponsBaseIni['wpn_aek_camo']
    wpn_aek_camo_1p29: ItemsWeaponsBaseIni['wpn_aek_camo']
    wpn_aek_camo_ps01: ItemsWeaponsBaseIni['wpn_aek_camo']
    wpn_aek_duty: ItemsWeaponsBaseIni['wpn_aek']
    wpn_aek_duty_hud: ItemsWeaponsBaseIni['wpn_aek_hud']
    wpn_aek_duty_1p29: ItemsWeaponsBaseIni['wpn_aek_duty']
    wpn_aek_duty_kobra: ItemsWeaponsBaseIni['wpn_aek_duty']
    wpn_aek_duty_ps01: ItemsWeaponsBaseIni['wpn_aek_duty']
  }
}
