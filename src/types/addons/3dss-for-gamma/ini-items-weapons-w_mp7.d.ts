...
// `items/weapons/w_mp7.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    wpn_mp7: {
      ...
      scripted_snd_bore_aim: string
      scripted_snd_bore_empty: string
      scripted_snd_bore_empty_aim: string
      scripted_snd_bore_jammed: string
      scripted_snd_bore_jammed_aim: string
    ...
    wpn_mp7_hud: {
      ...
      anm_ammo_check_empty_jammed: string
      anm_ammo_check_empty_jammed_aim: CommaSeparatedString<string[]>
      anm_ammo_check_jammed: string
      anm_ammo_check_jammed_aim: CommaSeparatedString<string[]>
      anm_bore: string
      anm_bore_aim: CommaSeparatedString<string[]>
      anm_bore_empty: string
      anm_bore_empty_aim: CommaSeparatedString<string[]>
      anm_bore_jammed: CommaSeparatedString<string[]>
      anm_bore_jammed_aim: CommaSeparatedString<string[]>
      ...
      anm_switch_mode_jammed_aim: CommaSeparatedString<string[]>
    ...
    wpn_mp7_ac10632: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_mp7_ac10632_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_eot: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_eot_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    'wpn_mp7_c-more': Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    'wpn_mp7_c-more_hud': Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_d0cter: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_d0cter_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_aim_low: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_aim_low_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_e0t2: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_e0t2_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_deltapoint: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_deltapoint_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_rmr: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_rmr_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_compm4s: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_compm4s_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_kemper: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_kemper_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_mp7_acog: Omit<ItemsWeaponsBaseIni['wpn_mp7'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_mp7_acog_hud: Omit<ItemsWeaponsBaseIni['wpn_mp7_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
