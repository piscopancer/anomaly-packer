...
declare global {
  interface ModSystemZz3dssAk5cBasIni {
    wpn_ak5c_bas_he510: {
      '1icon_layer': string
    ...
    wpn_ak5c_bas_t12_hud: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      '2icon_layer': string
      '2icon_layer_x': number
      '2icon_layer_y': number
      aim_hud_offset_alt_pos: vector
      aim_hud_offset_alt_pos_16x9: vector
      aim_hud_offset_alt_rot: CommaSeparatedString<string[]>
      aim_hud_offset_alt_rot_16x9: CommaSeparatedString<string[]>
    ...
    wpn_ak5c_bas_march_f_shorty: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak5c_bas_march_f_shorty_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_ak5c_bas_march_f_shorty_alt: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      '2icon_layer': string
    ...
    wpn_ak5c_bas_march_f_shorty_alt_hud: {
      aim_hud_offset_alt_pos: vector
      aim_hud_offset_alt_pos_16x9: vector
    ...
    wpn_ak5c_bas_e0t2_magd: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak5c_bas_e0t2_magd_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
    wpn_ak5c_bas_e0t2_magd_off: {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_ak5c_bas_e0t2_magd_off_hud: {
      aim_hud_offset_pos: vector
      aim_hud_offset_pos_16x9: vector
      item_visual: string
    }
  ...
  interface IniFileSchemas {
    'mod_system_zz_3dss_ak5c_bas.ltx': ModSystemZz3dssAk5cBasIni
  }
}
