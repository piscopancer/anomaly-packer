...
// `items/weapons/w_akm.ltx` is never opened directly — `items/weapons/base.ltx` globs it in, so these sections augment
...
declare global {
  interface ItemsWeaponsBaseIni {
    ...
    wpn_akm_1p29: Omit<ItemsWeaponsBaseIni['wpn_akm'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
    ...
    wpn_akm_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akm_kobra: Omit<ItemsWeaponsBaseIni['wpn_akm'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_akm_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akm_ps01: Omit<ItemsWeaponsBaseIni['wpn_akm'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'scope_dynamic_zoom' | 'scope_status' | 'scope_texture' | 'scope_zoom_factor'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_akm_pso1_hud: ItemsWeaponsBaseIni['wpn_akm_hud']
    wpn_akms: Omit<ItemsWeaponsBaseIni['wpn_akm'], 'description' | 'hud' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'parent_section' | 'scopes' | 'visual'> & {
      description: string
      hud: string
      inv_grid_x: number
      inv_grid_y: number
    ...
    wpn_akms_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akms_1p29: Omit<ItemsWeaponsBaseIni['wpn_akms'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_akms_1p29_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_1p29_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akms_kobra: Omit<ItemsWeaponsBaseIni['wpn_akms'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_akms_kobra_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_kobra_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akms_ps01: Omit<ItemsWeaponsBaseIni['wpn_akms'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_akms_pso1_hud: ItemsWeaponsBaseIni['wpn_akm_pso1_hud']
    wpn_akms_alt: Omit<ItemsWeaponsBaseIni['wpn_akms'], 'condition_queue_shot_dec' | 'condition_shot_dec' | 'cost' | 'fire_dispersion_base' | 'hud' | 'inv_grid_x' | 'inv_grid_y' | 'inv_name' | 'inv_name_short' | 'misfire_end_condition' | 'misfire_end_prob' | 'misfire_start_condition' | 'misfire_start_prob' | 'parent_section' | 'rpm' | 'visual'> & {
      condition_queue_shot_dec: number
      condition_shot_dec: number
      cost: number
      fire_dispersion_base: number
    ...
    wpn_akms_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_hud'], 'attach_place_idx' | 'item_visual' | 'zoom_hide_crosshair'> & {
      attach_place_idx: number
      item_visual: string
      zoom_hide_crosshair: boolean
    }
    wpn_akms_alt_1p29: Omit<ItemsWeaponsBaseIni['wpn_akms_alt'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_akms_1p29_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akms_sk1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akms_alt_kobra: Omit<ItemsWeaponsBaseIni['wpn_akms_alt'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud' | 'visual'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    ...
    wpn_akms_kobra_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akms_sk1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akms_alt_ps01: Omit<ItemsWeaponsBaseIni['wpn_akms_alt'], '1icon_layer' | '1icon_layer_x' | '1icon_layer_y' | 'hud'> & {
      '1icon_layer': string
      '1icon_layer_x': number
      '1icon_layer_y': number
      hud: string
    }
    wpn_akms_pso1_sk1_hud: ItemsWeaponsBaseIni['wpn_akms_sk1_hud']
    wpn_akm_1p29_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_sk1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akm_kobra_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_sk1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akm_pso1_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_sk1_hud'], 'item_visual'> & {
      item_visual: string
    }
    wpn_akm_sk1_hud: Omit<ItemsWeaponsBaseIni['wpn_akm_hud'], 'item_visual'> & {
      item_visual: string
    }
  }
}
