...
declare global {
  namespace tasks_chimera_scan {
    ...
    export function spawn_on_id(sec: Section.Item, id: number): CseAbstract
    export function spawn_on_squad_member(sec: Section.Item, id: number): CseAbstract
