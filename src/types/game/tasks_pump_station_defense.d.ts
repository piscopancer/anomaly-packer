...
declare global {
  namespace tasks_pump_station_defense {
    ...
    export function spawn_and_set(kill: boolean, sec: Section.Item, x: number, y: number, z: number, lvid: number, gvid: number, guard_profile: string, give_guns: boolean): number
