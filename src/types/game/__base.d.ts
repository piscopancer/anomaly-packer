...
declare global {
  ...
  class alife {
    ...
    create(section: Section.Item, pos: vector, level_vertex_id: number, game_vertex_id: number, parent_id?: number): CseAbstract
    create_ammo(section: Section.Item): CseAbstract
