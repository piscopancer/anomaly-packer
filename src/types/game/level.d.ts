...
declare global {
  namespace level {
    ...
    export function spawn_item(section: Section.Item, pos: vector, level_vertex_id: number, parent_id: number, return_item?: boolean): void
    ...
    export function add_complex_effector(section: Section.Item, id: number): void
