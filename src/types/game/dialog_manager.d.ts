...
declare namespace dialog_manager {
  ...
  export function action_tips_dialogs(npc: TODO, actor: TODO, dialog_name: TODO, id: TODO): void
  ...
  export function dm_agr_u_bandit_boss_reask(dialog: TODO, base_pid: TODO, next_pid: TODO): void
  export function dm_agr_u_bandit_boss_start(dialog: TODO): void
  export function dm_ashot_and_yar(a: TODO, b: TODO): void
  export function dm_init_dynamic_ashot_and_yar_dialog(dialog: TODO): void
  export function dm_init_dynamic_broker_dialog(dialog: TODO): void
  export function dm_init_dynamic_repair_dialog(dialog: TODO): void
  export function dm_init_dynamic_task_cancel_dialog(dialog: TODO): void
  export function dm_init_dynamic_task_completed_dialog(dialog: TODO): void
  export function dm_init_dynamic_task_dialog(dialog: TODO): void
  export function dm_init_sim_dynamic_task_cancel_dialog(dialog: TODO): void
  export function dm_init_sim_dynamic_task_completed_dialog(dialog: TODO): void
  export function dm_init_sim_dynamic_task_dialog(dialog: TODO): void
  export function dm_init_surrender_dialog(dialog: TODO): void
  export function drx_sl_cf_task_completed_dialog(dialog: TODO): TODO
  export function drx_sl_init_change_faction_dialog(dialog: TODO): void
  export function drx_sl_init_honcho_meet_dialog(dialog: TODO): void
  export function drx_sl_init_mechanic_task_dialog(dialog: TODO): void
  export function drx_sl_task_completed_dialog(dialog: TODO): TODO
  export function fill_phrase_table(): void
  export function fill_priority_anomalies_table(actor: TODO, npc: TODO, dialog_name: TODO, phrase_id: TODO): void
  export function fill_priority_hello_table(actor: TODO, npc: TODO, dialog_name: TODO, phrase_id: TODO): void
  export function fill_priority_information_table(actor: TODO, npc: TODO, dialog_name: TODO, phrase_id: TODO): void
  export function fill_priority_job_table(actor: TODO, npc: TODO, dialog_name: TODO, phrase_id: TODO): void
  export function fill_priority_table(npc: TODO, PT_subtable: TODO, PRT_subtable: TODO): void
  export function fill_priority_tips_table(actor: TODO, npc: TODO, dialog_name: TODO, phrase_id: TODO): void
  ...
  export function init_hello_dialogs(dialog: TODO): void
  export function init_new_dialog(dialog: TODO): void
  export function init_start_dialogs(dialog: TODO, str: TODO): void
  export function is_highest_priority_phrase(PT_subtable: TODO, PRT_subtable: TODO, npc: TODO, phrase_id: TODO): boolean
  export function is_told(npc: TODO, str: TODO): boolean
  export function precondition(npc: TODO, PT_subtable: TODO, PRT_subtable: TODO, phrase_id: TODO, dialog_name: TODO): boolean
  export function precondition_anomalies_dialogs(npc: TODO, actor: TODO, dialog_name: TODO, parent_id: TODO, id: TODO): boolean
  ...
  export function precondition_anomalies_dialogs_no_more(npc: TODO, actor: TODO, dialog_name: TODO, parent_id: TODO, id: TODO): boolean
  ...
  export function precondition_no_more(npc: TODO, str: TODO, phrase_id: TODO): boolean
  ...
  export function precondition_tips_dialogs_no_more(npc: TODO, actor: TODO, dialog_name: TODO, parent_id: TODO, id: TODO): boolean
  export function reset_phrase_priority(PT_subtable: TODO, PRT_subtable: TODO, npc: TODO, phrase_id: TODO): void
  export function set_phrase_highest_priority(PT_subtable: TODO, PRT_subtable: TODO, npc: TODO, phrase_id: TODO): void
  export function told(PRT_subtable: TODO, npc: TODO): void
