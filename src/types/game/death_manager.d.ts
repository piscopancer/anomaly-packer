...
declare namespace death_manager {
  ...
  export function create_item(npc: CGameObject, section: Section, number: number, rnd: boolean, to_save: boolean): void
  ...
  export function spawn_with_condition(npc: CGameObject, section: Section, condition: number): number
  export function try_spawn_ammo(npc: CGameObject): void
  export function validate_drop(section: Section): boolean
}
