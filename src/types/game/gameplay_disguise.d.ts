...
declare namespace gameplay_disguise {
  ...
  export function expose_actor(npc: CGameObject, comm: string, is_enem?: boolean): void
  export function get_default_comm(): string
  export function get_npc_awareness(sec: string): number
  export function get_outfit_comm(section: string): string
  /** @returns the patch section (string) or the patch item object, or `nil` */
  export function get_patch(faction: string, only_sec?: boolean): string | CGameObject | undefined
  ...
  export function set_comm(comm: string): void
  export function set_msg(str: string, comm?: string, comm2?: string): void
  ...
  export function update_default(comm: string, now?: boolean): void
