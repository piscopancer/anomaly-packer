...
declare global {
  namespace dialogs {
     ...
     */
    export function relocate_item_section(npc: CGameObject | null, section: Section.Item, type: RelocationType, amount?: number): void
    export function relocate_item_section_to_actor(speaker_1: CGameObject, speaker_2: CGameObject, section: Section.Item, amount?: number): void
    export function relocate_item_section_from_actor(speaker_1: CGameObject, speaker_2: CGameObject, section: Section.Item, amount?: number): void
    ...
    export function actor_has_item(first_speaker: CGameObject, second_speaker: CGameObject, section: Section.Item): boolean
    export function npc_has_item(first_speaker: CGameObject, second_speaker: CGameObject, section: Section.Item): boolean
