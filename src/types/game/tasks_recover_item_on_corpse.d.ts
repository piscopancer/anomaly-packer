...
declare global {
  namespace tasks_recover_item_on_corpse {
    ...
    export function spawn_on_id(section: Section.Item, target_id: number): CseAbstract | undefined
    export function spawn_on_id_position(section: Section.Item, target_id: number): CseAbstract | undefined
