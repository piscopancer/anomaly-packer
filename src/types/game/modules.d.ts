...
declare global {
  namespace modules {
    ...
    export function enable_generic_schemes(npc: CGameObject, ini: system_ini, section: Section.Item, stype: number): void
    export function on_game_start(): void
    export function reset_generic_schemes(npc: CGameObject, scheme: string, section: Section.Item): void
  }
}
