...
declare namespace stalker_generic {
  export function can_select_weapon(npc: TODO, scheme: TODO, st: TODO, section: TODO): void
  export function disable_invulnerability(npc: TODO): void
  export function get_infos_from_data(npc: TODO, s: TODO): TODO
  export function is_need_invulnerability(npc: TODO): boolean
  export function remove_level_spot(npc_id: TODO): void
