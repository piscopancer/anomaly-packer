...
declare namespace utils_item {
  ...
  export function collect_amount(npc: CGameObject, section: string, mode: number): TODO
  ...
  export function delay_event(to_create: string[], to_release: number[], effect: TODO, news?: boolean, delay?: number): void
  ...
  export function extract_upgrade(tree: TODO, group: string, not_first?: boolean): void
  ...
  export function get_ammo(section: string, id?: number, by_key?: boolean): TODO
  ...
  export function get_defined_uses(sec_d: string): TODO
  export function get_item_cost(obj: CGameObject, profile: TODO): number | false | undefined
  export function get_item_remaining_uses(obj: CGameObject): number
  export function get_item_trade_status(obj: CGameObject, profile: TODO): number | undefined
  export function get_outfit_belt_size(obj?: CGameObject, sec?: string): number | undefined
  export function get_outfit_property(obj: CGameObject, sec: string, name: string, def?: TODO): TODO
  export function get_outfit_protection(obj: CGameObject, sec: string, name: string, def?: number): number
  export function get_param(section: string, id: number, param: string, typ?: string, add?: boolean): TODO
  ...
  export function get_upgrades_installed(obj: CGameObject | null, id?: number, to_key?: boolean): TODO
  export function get_upgrades_tools(section: string): TODO
  export function get_upgrades_tree(section: string, new_table?: boolean): TODO
  export function get_wpn_param(obj: CGameObject, sec: string, name: string, def?: TODO): TODO
  ...
  export function is_overweight(npc: CGameObject, npc_id?: number, comp_weight?: number): TODO
  export function item_is_fa(o: CGameObject, c?: number): boolean
  export function on_game_start(): void
  export function on_get_item_cost(kind: string, obj: CGameObject, profile: TODO, calculated_cost: number, ret: TODO): void
  export function print_dbg(fmt: string, ...args: TODO[]): void
