...
declare global {
  namespace xr_logic {
    export function abort_syntax_error_in_cond(section: Section.Item, field: string, c: string): void
    export function activate_by_section(npc: CGameObject, ini: system_ini, section: Section.Item, gulag_name: string, loading: boolean): void
    export function assign_storage_and_bind(npc: CGameObject, ini: system_ini, scheme: string, section: Section.Item, temp?: boolean): AnyTable
    export function cfg_get_condlist(ini: system_ini, section: Section.Item, field: string, npc: CGameObject, cond_name?: string, str?: string): AnyTable | undefined
    export function cfg_get_npc_and_zone(ini: system_ini, section: Section.Item, field: string, npc: CGameObject, cond_name?: string): AnyTable
    export function cfg_get_number_and_condlist(ini: system_ini, section: Section.Item, field: string, npc: CGameObject, cond_name?: string, str?: string): AnyTable | undefined
    export function cfg_get_overrides(ini: system_ini, section: Section.Item, npc: CGameObject, l: AnyTable): AnyTable
    export function cfg_get_string_and_condlist(ini: system_ini, section: Section.Item, field: string, npc: CGameObject, cond_name?: string, str?: string): AnyTable | undefined
    export function cfg_get_switch_conditions(ini: system_ini, section: Section.Item, npc: CGameObject): AnyTable
    export function cfg_get_two_strings_and_condlist(ini: system_ini, section: Section.Item, field: string, npc: CGameObject, cond_name?: string, str?: string): AnyTable | undefined
    ...
    export function enable_generic_schemes(ini: system_ini, npc: CGameObject, stype: string, section: Section.Item): void
    ...
    export function parse_condlist(npc: CGameObject | null, section: Section.Item | null, field: string | null, src: string): AnyTable
    ...
    export function reset_generic_schemes_on_scheme_switch(npc: CGameObject, scheme: string, section: Section.Item): void
    ...
    export function set_new_scheme_and_logic(npc: CGameObject, scheme: string, section: Section.Item, logic: string, gulag: string, ini_filename: string): void
    export function spawn_items(npc: CGameObject, st: AnyTable): void
    export function str_from_condlist(obj: CGameObject, ini: system_ini, section: Section.Item, field: string): string | undefined
    export function subscribe_action_for_events(npc: CGameObject, storage: AnyTable, new_action: AnyTable): void
    export function switch_to_section(npc: CGameObject, ini: system_ini, section: Section.Item): boolean
