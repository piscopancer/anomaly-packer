...
declare namespace xr_effects {
  ...
  export function reward_random_item(actor: CGameObject, npc: CGameObject, ...sections: string[]): void
  export function reward_item(actor: CGameObject, npc: CGameObject, section: string): void
  ...
  export function remove_item(actor: CGameObject, npc: CGameObject, section: string, count: number | string): void
  export function spawn_item_to_npc(actor: CGameObject, npc: CGameObject, section: string): void
