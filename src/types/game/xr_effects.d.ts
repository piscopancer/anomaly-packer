...
declare global {
  namespace xr_effects {
    ...
    export function reward_random_item(actor: CGameObject, npc: CGameObject, ...sections: Section.Item[]): void
    export function reward_stash(actor: CGameObject, npc: CGameObject, random: boolean): void
    export function reward_item(actor: CGameObject, npc: CGameObject, section: Section.Item): void
    ...
    export function remove_item(actor: CGameObject, npc: CGameObject, section: Section.Item, count: number | string): void
    export function spawn_item_to_npc(actor: CGameObject, npc: CGameObject, section: Section.Item): void
