...
declare namespace closecaption {
  ...
  export function cc_display_radio(sender: CGameObject, sender_faction: Community, sender_id: string, showtime: number, cc_text: string, delay_sound: number, cc_type: string): boolean
  ...
  export function sound(_sound: string, showtime: number, sender: CGameObject, sender_faction: Community, sender_id: string, delay_sound: number): boolean
}
