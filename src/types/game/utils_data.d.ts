...
declare namespace utils_data {
  ...
  export function cfg_get_string(char_ini: system_ini, section: string, field: string, object: CGameObject, mandatory: boolean, gulag_name?: string, default_val?: string): string | undefined
  export function collect_section(ini: system_ini, section: string, keytable?: boolean): AnyTable
  ...
  export function parse_ini_section_to_array(ini: system_ini, section: string): AnyTable
  export function parse_ini_section_to_bool_array(ini: system_ini, section: string): Record<string, boolean>
  ...
  export function prefix_r_string(ini: system_ini, sec: string, key: string, prefix?: string): string | undefined
  ...
  export function read_from_ini(ini: system_ini, section: string, line: string, var_type: 'bool' | 'string' | 'float' | string, _default?: any, caller?: string): any
  ...
  export function w_stpk(stpk: net_packet, typ: string, n: any, info: string): void
}

/** @customConstructor cfg_file */
declare class cfg_file {
  constructor(fname: string, simple_mode?: boolean)
  GetValue(sec: string, key: string, typ?: number | string, def?: any): any
  GetKeys(sec: string): string[]
  SetValue(sec: string, key: string, val: any): void
